...
Run from the same directory as result_v4_symbol_interactions.xlsx and
Table_AllOutputs_SeparationIndex_vs_AUCratio.xlsx (or edit the paths below).
...
INTERACTIONS_XLSX = os.path.join(SCRIPT_DIR, 'result_v4_symbol_interactions.xlsx')
ALLOUTPUTS_XLSX   = os.path.join(SCRIPT_DIR, 'Table_AllOutputs_SeparationIndex_vs_AUCratio.xlsx')
