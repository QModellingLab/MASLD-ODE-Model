...
# -*- coding: utf-8 -*-
"""
step6_silymarin_validation.py  (GSE89632)  [Fig 6 equivalent]
================================================================
Independent-cohort validation of the silymarin intervention (Fig 6 analogue).

Feeds GSE89632-derived node initial ratios into the EXISTING v10 model, then
...
Reads ratios from step5 output (GSE89632_node_initial_ratios.xlsx). Run step5
first.

Outputs:
  GSE89632_silymarin_dynamics.xlsx   (t-half per stage x dose, per output)
...
RATIOS_XLSX = os.path.join(SCRIPT_DIR, 'GSE89632_node_initial_ratios.xlsx')

OUT_DYN = os.path.join(SCRIPT_DIR, 'GSE89632_silymarin_dynamics.xlsx')
...
def main():
    print('=' * 64)
    print('GSE89632 silymarin intervention validation (Fig 6 equivalent)')
    print('=' * 64)
    ...
    # Load GSE89632 node ratios per stage (from step5)
    ratios = {}
    ...
    plt.suptitle('GSE89632-driven silymarin intervention validation',
