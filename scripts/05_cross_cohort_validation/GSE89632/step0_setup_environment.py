...
SERIES_MATRIX_FILE = 'GSE89632_series_matrix.txt'
SERIES_MATRIX_GZ    = 'GSE89632_series_matrix.txt.gz'
SERIES_MATRIX_URL   = (
    'https://ftp.ncbi.nlm.nih.gov/geo/series/GSE89nnn/'
    'GSE89632/matrix/GSE89632_series_matrix.txt.gz'
)
...
def main():
    print('=' * 64)
    print('GSE89632 Validation Pipeline — 環境準備檢查')
